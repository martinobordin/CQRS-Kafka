...
Action<DbContextOptionsBuilder> configureDbContext = o => o.LogTo(Console.WriteLine).UseLazyLoadingProxies().UseSqlServer(builder.Configuration.GetConnectionString("SqlServer"));
